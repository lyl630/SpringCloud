    ...
    <script>
        ...
        function del(id) {
            Ewin.confirm({ message: "确认要删除选择的数据吗？" }).on(function (e) {
                ...
                location.href="http://localhost:8080/Storm/deleteInStockById?inStockVO.inStockId="+id;
            });
        }
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><s:if test="#inStock.statusId == 1"><a href="Storm/toUpdateStatus?inStockVO.inStockId=${inStock.id}">编辑</a></s:if><s:else><a href="showInStockInfoById?inStockVO.inStockId=${inStock.id}">查看</a></s:else></li>
                                    <li class="divider"></li>
