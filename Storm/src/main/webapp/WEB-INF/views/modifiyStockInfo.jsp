    ...
    <script>
        $(function () {
            ...
            function medicineList(name,prescriptionTypeId) {
                $.ajax({
                    url:'Storm/inmedicine?medicineVO.prescriptionTypeId='+prescriptionTypeId+'&medicineVO.name='+name,
                    type:'post',
        ...
        function save(status,inStockId) {
            $.ajax({
                url:'Storm/delInStock?inStockVO.inStockId='+inStockId,
                success:function () {
                    var n = 0;
                    $.ajax({
                        url: 'Storm/doAddInStock',
                        type: 'post',
                        ...
                        success:function (data) {
                            ...
                            location.href="http://localhost:8080/Storm/inStock/inStock"
                        }
                    });
                }
            })
