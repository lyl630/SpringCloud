...
<div class="container">
    <ul class="pagination pagination-lg">
        <li><a href="Storm/medicines?pageNo=<s:property value="%{pageNo-1}"/>">«</a></li>
        <s:iterator begin="1" end="#pageCount" var="g">
            <li><a href="Storm/medicines?pageNo=<s:property value="#g"/>"><s:property value="#g"/></a></li>
        </s:iterator>
        <li><a href="Storm/medicines?pageNo=<s:property value="#pageCount"/>">»</a></li>
