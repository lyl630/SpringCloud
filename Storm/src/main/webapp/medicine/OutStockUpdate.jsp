            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a hrefmedicine/toinventorydetailbyinfo="http://localhost:8080/Storm/medicine/outstock">出库管理</a></li>
...
<script>
    $(function () {
        ...
        $("#fat-btn").click(function(){
                $.ajax({
                    url: 'Storm/findmedicine?medicineVo.prescriptionId='+$("#prescriptionId").val()+"&medicineVo.mno="+$("#mno").val(),
                    type: 'post',
    ...
    $("[name=count]").on('blur',function () {
        ...
        $("[name=btn]").click(function () {
            $.ajax({
                url: 'Storm/findmedicine?outstockVo.outstockno=张三',
                type: 'post',
                success: function (data) {
                    alert(data)
        ...
        data:
            ...
            success: function (data) {
                ...
                $(".tr").each(function (i) {
                    ...
                    alert("提交成功！");
                    location.href='http://localhost:8080/Storm/medicine/outstock';
            }
    });
