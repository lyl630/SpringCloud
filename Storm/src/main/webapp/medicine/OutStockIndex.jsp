            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="http://localhost:8080/Storm/inStock">入库管理</a></li>
                        <li><a href="http://localhost:8080/Storm/medicine/outstock">出库管理</a></li>
                        <li><a href="http://localhost:8080/Storm/medicine/findinventory">库存盘点</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<button style="float: right" id="add-btn" class="btn btn-primary" onclick="location.href='http://localhost:8080/Storm/medicine/toaddoutstock'" data-loading-text="Loading..."
        type="button">新增入库
</button>
<div align="center">
        ...
        <tr>
            ...
            <td>
                <s:if test="#g.statusid==2||#g.statusid==1">
                    <button type="button"onclick="location.href='http://localhost:8080/Storm/medicine/outstockdetail?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">查看</button>|
                </s:if>
                <s:if test="#g.statusid==3">
                    <button type="button" onclick="location.href='http://localhost:8080/Storm/medicine/toupdateoutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm">编辑</button>|
                </s:if>
                <button type="button" onclick="location.href='http://localhost:8080/Storm/medicine/deloutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">删除</button> |
                <s:if test="#g.statusid==1||#g.statusid==2">
                    <button type="button" onclick="location.href='http://localhost:8080/Storm/medicine/addagainoutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">再次出库</button>
                </s:if>
            </td>
        </tr>
    </s:iterator>
